...
// //               className="hidden md:flex items-center gap-2 w-64 h-10 px-4 bg-gray-100 hover:bg-gray-200 rounded-full text-sm text-gray-600 transition-colors"
// //             >
...
// //               className="px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl font-semibold hover:shadow-lg hover:shadow-blue-500/30 transition-all flex items-center gap-2"
// //             >
// //               <PlusSquare className="w-4 h-4" />
// //               <span className="hidden lg:inline">Create</span>
// //             </button>
// //             <div className="relative group">
// //               <button className="w-10 h-10 rounded-full overflow-hidden border-2 border-blue-200 hover:border-blue-400 transition-colors">
// //                 <img
// //                   src={
...
// //                 />
// //               </button>
// //               <div className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-xl border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
...
// //                   className="w-full flex items-center gap-3 px-4 py-2.5 hover:bg-gray-50 border-t transition-colors text-red-600"
// //                 >
...
// //                 <button
// //                   onClick={() => setShowCreatePost(true)}
// //                   className="px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl font-semibold hover:shadow-lg hover:shadow-blue-500/30 transition-all"
// //                 >
...
// //               </div>
// //               <p>© 2024 Frendly from Anthropic</p>
// //             </div>
// //           </div>
// //         </div>
// //       </div>
...
// //           <button
// //             onClick={() => setShowCreatePost(true)}
// //             className="p-3 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-full shadow-lg"
// //           >
...
//                 <button
//                   onClick={() => router.push(`/profile/${currentUser?._id}`)}
//                   className="w-full mt-4 px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-sm font-semibold rounded-xl hover:shadow-lg hover:shadow-blue-500/30 transition-all"
//                 >
//                   View Profile
//                 </button>
//               </div>
...
//               </div>
//               <p className="text-gray-400">© 2024 Frendly from Anthropic</p>
//             </div>
//           </div>
//         </div>
//       </div>
