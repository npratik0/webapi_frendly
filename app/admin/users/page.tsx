...
// // import UsersPageClient from "./UsersPageCilent";
...
// // async function fetchUsers(searchParams: Promise<SearchParams>) {
...
// //             `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/admin/users?${queryParams.toString()}`,
// //             {
// //                 headers: {
...
// //     try {
// //         // If you don't have a stats endpoint, you can calculate from the users data
// //         const response = await fetch(
// //             `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/admin/users?page=1&size=1000`,
// //             {
// //                 headers: {
// //                     'Authorization': `Bearer ${token}`,
// //                     'Content-Type': 'application/json',
...
// //             inactiveUsers: users.filter((u: any) => u.status?.toLowerCase() === 'inactive').length,
// //             adminUsers: users.filter((u: any) => u.role?.toLowerCase() === 'admin').length,
// //         };
// //     } catch (error) {
...
// // }) {
// //     const usersData = await fetchUsers(searchParams);
...
// //         const url = `${apiUrl}/api/admin/users?${queryParams.toString()}`;
...
// //     try {
// //         const apiUrl = process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5050';
// //         const url = `${apiUrl}/api/admin/users?page=1&size=1000`;
